...
namespace LittleCafe
{
    ...
    public class GridEntityHPBar : MonoBehaviour
    {
        ...
        // Static font cache for neutral HP labels
        ...
        private void SpawnDamagePopup(int damageDealt, int currentHP, int maxHP)
        {
            ...
            GridEntityDamagePopup.Spawn(
                transform.position, actualLabelHeight,
                damageDealt, currentHP, maxHP,
                isBuilding, entityDamageColor, outlineColor,
                overrideFont, damageFloatDistance, damageDuration,
                damageFontSize, randomSpreadX);
        }
        ...
        private TMP_FontAsset GetNeutralFont()
        {
            ...
            cachedNeutralFont = GridEntityDamagePopup.GetFallbackFontAsset();
            return cachedNeutralFont;
        }
