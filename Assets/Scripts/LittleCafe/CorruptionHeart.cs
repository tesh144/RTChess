...
namespace LittleCafe
{
    ...
    public class CorruptionHeart : MonoBehaviour
    {
        ...
        /// <summary>
        /// Moore neighbourhood radius for pre-corrupting tiles around this heart on spawn.
        /// Set by MapGeneratorV2 from CorruptionSpawnEntry.initialCorruptionRadius.
        /// 1 = heart cell + 8 surrounding tiles. 0 = heart cell only.
        /// </summary>
        public int InitialCorruptionRadius { get; set; } = 1;
