...
/// <summary>
/// Custom inspector for PlacementCostsDatabase.
...
///
/// Note: cost tables (from SheetSyncEditor) take priority over base cost + increment at runtime.
/// </summary>
[CustomEditor(typeof(PlacementCostsDatabase))]
public class PlacementCostsDatabaseEditor : Editor
{
    private PlacementCostsDatabase config;
    ...
    {
        config = (PlacementCostsDatabase)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("Placement Costs Database", EditorStyles.boldLabel);
        EditorGUILayout.HelpBox(
            "Placement costs for all items. Each item can have up to 3 resource cost slots.\n" +
            "Cost tables (from Sheet Sync) take priority over Base Cost + Increment at runtime.\n" +
            "Use ClockworkCraft → Sheet Sync → Sync Placement Costs to populate from Google Sheets.",
            MessageType.Info);
    ...
    private void SyncFromDatabases()
    {
        ...
        Debug.Log($"[PlacementCostsDatabase] Synced {newEntries.Count} entries " +
